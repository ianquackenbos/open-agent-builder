...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    className={cn(
      ...
      "inline-flex items-center justify-center rounded-8 px-12 py-8 text-label-medium bg-brand-600 text-accent-white transition-colors hover:opacity-95 disabled:opacity-50 disabled:cursor-not-allowed",
      className,
    )}
    {...props}
  />
